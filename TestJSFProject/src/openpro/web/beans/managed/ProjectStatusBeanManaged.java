...
@ManagedBean (name = "ProjectStatusWebBean")
@SessionScoped

public class ProjectStatusBeanManaged {
	...
	private List<ProjectStatusWrapper>projectListWrappers=new ArrayList<ProjectStatusWrapper>();
	private ProjectStatusWrapper selectedProjectWrapper;
	
	/**
	 * @return the selectedProjectWrapper
	 */
	public synchronized ProjectStatusWrapper getSelectedProjectWrapper() {
		return selectedProjectWrapper;
	}

	/**
	 * @param selectedProjectWrapper the selectedProjectWrapper to set
	 */
	public synchronized void setSelectedProjectWrapper(
			ProjectStatusWrapper selectedProjectWrapper) {
		this.selectedProjectWrapper = selectedProjectWrapper;
	}

	public List<ProjectStatusWrapper> getProjectListWrappers() {
		//if(projectListWrappers.size()>0)
			//return projectListWrappers;
		
		projectListWrappers.clear();
		List<Projecttbl>pList=new ArrayList<Projecttbl>();
		pList.clear();
		
		pList=projectBean.getProjectList();
		for(int i=0;i<pList.size();i++)
			projectListWrappers.add(new ProjectStatusWrapper(pList.get(i)));
	...
	/**
	 * @param projectListWrappers the projectListWrappers to set
	 */
	public synchronized void setProjectListWrappers(
			List<ProjectStatusWrapper> projectListWrappers) {
		this.projectListWrappers = projectListWrappers;
	}

			
		/*
		public  List<WbsStatusWrapper> get_project_wbs_wrapper_list()
		{
			if(selectedProjectWrapper==null)
				return null;
			return selectedProjectWrapper.getWbsStatusWrappers();
		}
		*/
	//end of wrapper
	public class ProjectStatusWrapper
	{
		...
		{
			System.out.println("Entered:ProjectStatusWrapper::getWbsStatusWrappers");
			if(projectTbl==null)
			{
				System.out.println("ProjectStatusWrapper::getWbsStatusWrappers:projectTbl=null");
				return null;
			}
			...
			System.out.println("Exited:ProjectStatusWrapper::getWbsStatusWrappers");
		...
		public ProjectStatusWrapper(Projecttbl pTable)
		{
			projectTbl=pTable;
